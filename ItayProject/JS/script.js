...
document.addEventListener("DOMContentLoaded", function () {
    const mealPreference = document.getElementById("diet-category");
    ...
    mealPreference.addEventListener("change", function () {
        const selectedPreference = mealPreference.value;
        let description = "Here's a diet plan based on your preferences: "
            const dietCategory = document.getElementById(selectedPreference + "-diet");
            description += dietCategory.textContent;

        dietDescription.textContent = description;
